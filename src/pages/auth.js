...
const Login = () =>{
    ...
    const onSubmit = async (event) =>{
        ...
        try {
           const responce = await axios.post("https://mern-recipe-79rh.onrender.com/auth/login", {username, password});
...
const Register = () =>{
    ...
    const onSubmit = async (event) =>{
        event.preventDefault();
        try {
            const responce= await axios.post("https://mern-recipe-79rh.onrender.com/auth/register", {username, password});
